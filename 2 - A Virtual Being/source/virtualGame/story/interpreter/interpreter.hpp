...
private:
	...
	const Vector2 getDrawPosition(const float xIndex, const float yIndex) const;
...
private:
	...
	size_t m_drawLine, m_drawCharacter;
	float m_delay;

	Shader m_buttonShader;
	UniformBuffer m_buttonUniforms;
	Mesh m_buttonMesh;
	Instance m_buttonInstance;
};